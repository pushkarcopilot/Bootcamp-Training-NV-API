...
namespace Bootcamp.Data.Services
{
    ...
    public class AuthUser : IAuthUser
    {
        ...
        private readonly string _jsonFilePath = Path.Combine(Directory.GetCurrentDirectory(), "..", "Bootcamp.Data", "Data", "userList.json");
        private readonly string _jsonFilePathRegister = Path.Combine(Directory.GetCurrentDirectory(), "..", "Bootcamp.Data", "Data", "RegisterUser.json");
